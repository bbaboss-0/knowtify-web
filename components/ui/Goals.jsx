...
const sdgGoals = [
  { 
    img: "/assets/img/sdg/sdg2.png",
    gif:  "/assets/img/sdg/zero hunger.gif",
    title: "SDG 2: Zero Hunger", 
    description: "End hunger, achieve food security and improved nutrition, and promote sustainable agriculture." 
  },
  { 
    img: "/assets/img/sdg/SDG 9.jpg",
    gif: "/assets/img/sdg/9_SDG_MakeEveryDayCount_Gifs_GDU.gif",
  ...
  { 
    img: "/assets/img/sdg/sd12.png",
    gif: "/assets/img/sdg/12_SDG_MakeEveryDayCount_Gifs_GDU.gif",
    title: "SDG 12: Responsible Consumption and Production", 
    description: "Ensure sustainable consumption and production patterns." 
  },
  { 
    img: "/assets/img/sdg/sdg 13.png",
    gif: "/assets/img/sdg/13_SDG_MakeEveryDayCount_Gifs_GDU (1).gif",
    title: "SDG 13: Climate Action", 
    description: "Take urgent action to combat climate change and its impacts." 
  },  
  { 
    img: "/assets/img/sdg/sdg17.png",
    gif: "/assets/img/sdg/17_SDG_MakeEveryDayCount_Gifs_GDU.gif",
